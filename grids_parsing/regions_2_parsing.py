...
url = 'https://bi.gks.ru/biportal/tmp/grid5b2df0c9-2bbc-45a7-9708-35e3398390b6/vaxis.png'
...
session.cookies.update({
    "JSESSIONID": "37A4CE986EE87F3B7B5392C6C5ED9A8E",
...
#try/else блок для загрузки + проверка ошибок
    try:
        ...
        if response.status_code == 200:
            ...
            with open("../png/vaxis_2.png", "wb") as f:
