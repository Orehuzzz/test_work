...
url = 'https://bi.gks.ru/biportal/tmp/grid7a3d968b-6e2c-4c5b-8ceb-f64813cac883/grid.png'
...
#Подставляем refer своего изображения
...
session.cookies.update({
    "JSESSIONID": "88FCFE416F5E6AB2A38F13DA27146AC1", #Подставляем необходимый JSESSIONID
    # добавляем Cookie,если нужно
})

# Подставляем необходимое кол-во попыток
max_retries = 10
...
#try/else блок для загрузки + проверка ошибок
    try:
        ...
        if response.status_code == 200:
            ...
            with open("../png/grid.png", "wb") as f: #Подставьте свой путь до png
